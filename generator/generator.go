...
func fileMap() map[string]string {
	return map[string]string{
		...
		"app/utils/pagination.py":           "templates/app/utils/pagination.py.tmpl",
		"app/utils/responses.py":            "templates/app/utils/responses.py.tmpl",
		"app/utils/exceptions.py":           "templates/app/utils/exceptions.py.tmpl",
